...
RENNUM=0
PRGOPT="select option from tbl_prgoption where hospnum=${14} and prgid='${PROGRAMID}' and kbncd='SYOHO';"
INIFILE="/tmp/${14}${PROGRAMID}SYOHO.INI"
#-------------------------------------------#
#    ÃÏÊý¸øÈñºîÀ®¡Ê»°½Å¡¦Ê¡»ã°åÎÅÈñÎÎ¼ý¾ÚÌÀ½ñ¡Ë
#        $1-${11}
