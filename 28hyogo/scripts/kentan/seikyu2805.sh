...
PRGOPT2="select option from tbl_prgoption where hospnum=${14} and prgid='${PROGRAMID}' and kbncd='SEINENGETU';"
INIFILE="/tmp/${14}${PROGRAMID}TAISYOKOHI.INI"
INIFILE2="/tmp/${14}${PROGRAMID}SEINENGETU.INI"
#-------------------------------------------#
#    ÃÏÊý¸øÈñºîÀ®¡ÊÊ¼¸Ë¡¦Ê¡»ã¡Ë
#        $1-${11}
